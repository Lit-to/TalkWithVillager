...
execute unless score @s talk matches -2147483648..2147483647 run scoreboard players set @s talk -1
execute if score @s talk matches -1 run data modify storage twv: out set value []
execute if score @s talk matches -1 run data modify storage twv: out set from entity @s Inventory[0].tag.pages
...
execute if data storage twv: {out:[]} run function twv:fin
