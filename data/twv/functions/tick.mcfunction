...
#execute as @e[type=villager,scores={talk=0..}] at @s positioned ~ ~2 ~ run particle dust 0.2 1 0 0.5 ~ ~ ~ 0 0 0 1 1 force @a
execute as @e[type=villager,scores={talk=0..}] at @s unless entity @a[distance=..4,sort=nearest,limit=1] run function twv:far
